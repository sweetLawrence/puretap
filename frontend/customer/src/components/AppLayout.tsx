  ...
  return (
    <AppShell
      ...
      navbar={
        isMobile
          ? undefined
          : { width: 220, breakpoint: 'md', collapsed: { mobile: !opened } }
      }
      padding={0}
    >
      {/* Header */}
      ...
      {!isMobile && (
        ...
        `}
                >
                  ...
                  <span
                    className={active ? 'text-primary-600' : 'text-text-400'}
                  >
                    {item.icon}
                  </span>
                  {item.label}
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center gap-0.5 px-3 py-1 transition-colors ${
                    active ? 'text-primary-500' : 'text-text-300'
                  }`}
                >
                  {item.icon}
                  <span
