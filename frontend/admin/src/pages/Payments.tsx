...
// //   Table, Group, Stack, Alert, Skeleton, SegmentedControl
// // } from '@mantine/core'
...
// //   invoices: { invoice_no: string; total_amount: number; amount_paid?: number; remaining_balance?: number }
// // }
...
// // const STATUS_COLORS: Record<string, string> = {
// //   pending: 'yellow', 
// //   successful: 'green',  // Changed from 'completed' to 'successful'
// //   failed: 'red', 
// //   reversed: 'gray'
// // }
...
// //           is_partial: paid > 0 && remaining > 0 && inv.status !== 'paid'
// //         }
// //       }).filter((inv: Invoice) => ['unpaid', 'overdue'].includes(inv.status) || (inv.remaining_balance || 0) > 0)
...
// //   const successfulPayments = filtered.filter(p => p.status === 'completed').length
