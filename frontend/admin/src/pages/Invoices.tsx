...
//   overdue: 'red', disputed: 'orange', cancelled: 'gray', partial: 'blue'
// }
...
//       // Create a map of invoice_id -> total paid (only completed payments)
...
//         // Use calculated total from payments, fallback to invoice.amount_paid
...
//         return i.display_status === statusFilter
//       })
//     }
//     setFiltered(data)
...
//   const getDisplayAmount = (inv: Invoice) => {
//     if (inv.is_partial) return inv.remaining_balance
//     return inv.total_amount
//   }

//   const getStatusBadge = (inv: Invoice) => {
//     if (inv.is_partial) {
//       const percentPaid = ((inv.amount_paid / inv.total_amount) * 100).toFixed(0)
//       return (
...
//           <Text fw={700} size="sm" className={inv.status === 'overdue' ? 'text-red-500' : 'text-primary-600'}>
//             KES {getDisplayAmount(inv).toLocaleString()}
//           </Text>
//           {inv.is_partial && (
...
//             </button>
//           )}
//           {['unpaid', 'overdue'].includes(inv.status) && !inv.is_partial && (
//             <button disabled={statusUpdating === inv.id}
...
//         const total = Number(inv.total_amount)
//         const remaining = total - totalPaid
//         // Only consider partial if paid > 0 AND remaining > 0 AND not fully paid
...
//     if (inv.is_partial && inv.percent_paid > 0) {
//       return (
//         <Badge size="sm" radius="sm" variant="light" color="blue">
